...
- Сбор информации о привязанном канале пользователя через MTProto-юзерботов и учет каналов с подозрительными метриками (подписчики < 10, постов < 50, возраст < 10 месяцев)
