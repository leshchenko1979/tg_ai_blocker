# Антиспам-бот для Telegram: Техническое задание
...
### Логика настройки и подтверждения
- После добавления в группу и выдачи всех необходимых прав бот отправляет приветственное сообщение в группу.
- Администратор, выдавший права, получает личное сообщение с подтверждением завершения настройки: бот сообщает, что защита активирована и готов помочь.
